# Generated from MiniLang.g4 by ANTLR 4.7.2
# encoding: utf-8
from antlr4 import *
...
class MiniLangParser ( Parser ):
    ...
    def prog(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MiniLangParser.T__1) | (1 << MiniLangParser.ID) | (1 << MiniLangParser.INT) | (1 << MiniLangParser.NEWLINE))) != 0)):
                    break
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if token in [MiniLangParser.INT]:
                ...
                pass
            elif token in [MiniLangParser.ID]:
                ...
                self.match(MiniLangParser.ID)
                pass
            elif token in [MiniLangParser.T__1]:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        self.state = 32
                        _la = self._input.LA(1)
                        if not(_la==MiniLangParser.MUL or _la==MiniLangParser.DIV):
                        ...
                        self.state = 35
                        _la = self._input.LA(1)
                        if not(_la==MiniLangParser.ADD or _la==MiniLangParser.SUB):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
